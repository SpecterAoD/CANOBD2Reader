...
extern "C" CANOBD2_METADATA_USED CANOBD2_METADATA_SECTION const char CANOBD2_FIRMWARE_METADATA[] =
    ...
    "schema=" CANOBD2_STRINGIFY(CANOBD2_OTA_METADATA_SCHEMA) ";"
    "protocol=" CANOBD2_STRINGIFY(CANOBD2_PROTOCOL_VERSION) ";"
    "min_protocol=" CANOBD2_STRINGIFY(CANOBD2_MIN_COMPAT_PROTOCOL_VERSION) ";"
    "max_protocol=" CANOBD2_STRINGIFY(CANOBD2_MAX_COMPAT_PROTOCOL_VERSION) ";"
